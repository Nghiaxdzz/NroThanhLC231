...
public class BackgroudEffect
{
	...
	{
		if (FunctionGraphic.enableHideBgItem || mSystem.clientType == 1 || GameCanvas.lowGraphic || nCloud == 0 || imgCloud1 == null)
		{
			return;
		}
		for (int i = 0; i < nCloud; i++)
	...
	{
		if (FunctionGraphic.enableHideBgItem || mSystem.clientType == 1 || GameCanvas.lowGraphic || !isFog || imgFog == null)
		{
			return;
		}
	...
	{
		if (!FunctionGraphic.enableHideBgItem && typeEff == 10)
		{
	...
	{
		if (FunctionGraphic.enableHideBgItem)
		{
			return;
		}
