...
public class mGraphics
{
	...
	public void drawLine(int x1, int y1, int x2, int y2)
	{
		...
		float num = 57.29578f * Mathf.Atan(vector3.y / vector3.x);
		if (vector3.x < 0f)
		{
			num += 180f;
		}
		...
		Graphics.DrawTexture(new Rect(vector.x - (float)num3, vector.y - (float)num2 - (float)num4, vector3.magnitude, 1.6f), texture2D);
		if (isClip)
		{
			GUI.EndGroup();
		}
	...
	public void drawString(string s, float x, float y, GUIStyle style)
	{
		...
		GUI.Label(new Rect(x - (float)num, y - (float)num2, ScaleGUI.WIDTH, 100f), s, style);
		if (isClip)
		{
			GUI.EndGroup();
		}
	...
	{
		if (((image == GameScr.imgPanel || image == GameScr.imgPanel2 || image == GameScr.imgChatPC || image == GameScr.imgChatsPC2 || image == GameScr.imgChat || image == GameScr.imgChat2 || image == GameScr.imgHP || image == GameScr.imgHP1 || image == GameScr.imgHP2 || image == GameScr.imgHP3 || image == GameScr.imgHP4 || image == GameScr.imgMenu || image == GameScr.imgMP || image == GameScr.imgMPLost || image == GameScr.imgPanel || image == GameScr.imgPanel2 || image == GameScr.imgSkill || image == GameScr.imgSkill2 || image == GameScr.imgHPLost) && FunctionGraphic.enableHideGameUI) || (image == ItemMap.imageFlare && (FunctionGraphic.enableHideItem || FunctionGraphic.enableHideEffect)) || (image == TileMap.imgLight && FunctionGraphic.enableHideBgItem))
		{
			image = null;
		}
		if (image != null)
