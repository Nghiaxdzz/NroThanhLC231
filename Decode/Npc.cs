...
public class Npc : Char
{
	...
	{
		if (FunctionGraphic.enableHideNpc || Char.isLoadingMap || isHide || !isPaint() || statusMe == 15)
		{
			return;
		}
		if (cTypePk != 0)
	...
	{
		if (FunctionGraphic.enableHideNpc || Char.isLoadingMap || isHide || !isPaint() || statusMe == 15 || template == null)
		{
			return;
		}
		if (template.npcTemplateId == 3)
