...
public class Menu
{
	...
	{
		imgMenu1 = (FunctionGraphic.enableSpecialUI ? FunctionGraphic.createUI("menu1") : GameCanvas.loadImage("/mainImage/myTexture2dbtMenu1.png"));
		imgMenu2 = (FunctionGraphic.enableSpecialUI ? FunctionGraphic.createUI("menu2") : GameCanvas.loadImage("/mainImage/myTexture2dbtMenu2.png"));
	}
	...
	public void paintMenu(mGraphics g)
	{
		...
		for (int i = 0; i < menuItems.size(); i++)
		{
			...
			for (int j = 0; j < array.Length; j++)
			{
				...
				StringHandle.paint(mFont.tahoma_7_white, g, (i + 1).ToString(), menuX + i * menuW + 50, menuTemY[i], 0, mFont.tahoma_7b_dark, "border", mGraphics.zoomLevel);
			}
		}
		g.translate(-g.getTranslateX(), -g.getTranslateY());
	}
