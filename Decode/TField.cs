...
public class TField : IActionListener
{
	...
	public void paint(mGraphics g)
	{
		...
		paintInputTf(g, flag, x, y - 1, width, height + 5, TEXT_GAP_X + offsetX + x + 1, y + (height - mFont.tahoma_8b.getHeight()) / 2 + 2, StringHandle.Unikey.enableUnikey ? StringHandle.Unikey.ConvertText(paintedText) : paintedText, name);
